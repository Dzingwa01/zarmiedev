...
@section('content')
  ...
  <div class="container-fluid" style="margin-top:10em;">
    <div class="row">
      <div class="col m3">
        <a id="add_menu" class="btn"  data-toggle="modal" data-target="#add_ingredient_popup"  ><i class="material-icons">add</i>Add Ingredient</a><br/>
        <br/>
        <a id="add_ingredient_type" class="btn"  href="{{route('ingredient_type_home')}}"  ><i class="material-icons">add</i>Ingredient Types</a>
