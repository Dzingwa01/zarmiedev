...
<div class="navbar-fixed">
    <nav class="white" role="navigation" style="height: 5em;">
        <div class="nav-wrapper ">
            <a id="logo-container" href="{{url('/')}}" class="brand-logo"><img height="70px" width="100px"
                                                                               class="img-rounded"
                                                                               src={{URL::asset('pictures/logo.png')}} />
            </a>
            ...
            <ul class="right hide-on-med-and-down">
                <li><a class="" style="color:black;font-weight: bolder;" href="!#" data-toggle="modal"
                       data-target="#login_modal"><i class="material-icons left">add_shopping_cart</i> Order Now</a>
                </li>
                ...
                <li><a class="" style="color:black;font-weight: bolder;" href="/order_display"><i
                                class="material-icons left">reorder</i> Menu</a></li>
                {{-- <li><a class="btn"><i class="material-icons left">info</i> About Us</a></li> --}}
                <li><a class="" style="color:black;font-weight: bolder;" href="/contact_display"><i
                                class="material-icons left">email</i> Contact Us</a></li>
                <li>
                    <a style="color:black;font-weight: bolder;" class="dropdown-trigger_cus2" data-toggle="dropdown"
                       href="#dropdown2">
            ...
            <ul id="slide-out" class="sidenav">
                <li><a class="" style="color:black;font-weight: bolder;" href="/"><i
...
<div class="slider">
    <ul id="slides" class="slides">
        <li class="parallax-container"><img src="{{URL::asset('pictures/sandwich_slider.jpg')}}"
                                            class="img-responsive parallax"/>
            <div class="caption">
                <p class="z-depth-1 slide_p" style="margin-right:1em;font-weight:bolder;font-size:1.5em;">Sandwich of
                    the week, only R16.99, order now! </p>
        ...
        <li><img src="{{URL::asset('pictures/salad_slider.jpg')}}" class="img-responsive"/>
            <div class="caption">
                <p class="z-depth-1 slide_p" style="margin-right:1em;font-weight:bolder;font-size:1.5em;">Farm fresh
                    salads up for grabs, hurry now! </p>
                {{-- <button id="order_btn" class="btn" data-toggle="modal" style="margin-top:1em;margin-bottom:1em;" data-target="#order_popup_dialog">Order Now</button> --}}
            </div>
        </li>
        <li><img src="{{URL::asset('pictures/veg_slider.jpg')}}" class="img-responsive"/>
            <div class="caption">
                <p class="z-depth-1 slide_p" style="margin-right:1em;font-weight:bolder;font-size:1.5em;">We also cater
                    for vegeteranians, order now to get awesome deals! </p>
                {{-- <button id="order_btn" class="btn" data-toggle="modal" style="margin-top:1em;margin-bottom:1em;" data-target="#order_popup_dialog">Order Now</button> --}}
            </div>
        </li>
        <li><img src="{{URL::asset('pictures/platter_slider.jpg')}}" class="img-responsive"/>
            <div class="caption">
                <p class="z-depth-1 slide_p" style="margin-right:1em;font-weight:bolder;font-size:1.5em;">Catering for
                    many people, we have got awesome tray specials starting from R55.00! </p>
                {{-- <button id="order_btn" class="btn" data-toggle="modal" style="margin-top:1em;margin-bottom:1em;" data-target="#order_popup_dialog">Order Now</button> --}}
            </div>
        </li>
    </ul>
...
<div class="container">
        <div class="row">
            <div class=" col s12 col m4 card">
                ...
                <div class="card-content">
                    ...
                    <p style="text-align:justify;color:black!important;">Choose one of our delicious fillings or design
                        your own sandwich large or medium...
                    </p>
                </div>
                <div class="card-action">
                    <a id="sandwich_popup" title="More Information" class="pull-left " data-toggle="modal"
                       data-target="#sandwich_popup_dialog" style="margin-bottom: 1em;color:teal"><i
                                class=" material-icons left">info</i></a>
                    <a title="Order Now" href="order_display" class="pull-right "><i class="  material-icons left"
                                                                                     style="margin-bottom: 1em; color:teal">add_shopping_cart</i>
                    </a>
                </div>
            ...
            <div class="col s12 m4 card">
                ...
                <div class="card-content">
                    ...
                    <p style="text-align:justify;color:black!important;">Party size salads are available on request. All
                        dressings are served on the side..</p>

                </div>
                <div class="card-action">
                    <a id="salads_popup" title="More Information" data-toggle="modal"
                       style="margin-top:1em;margin-bottom:1em;" data-target="#salads_popup_dialog"><i
                                class=" material-icons left" style="margin-bottom: 1em;color:teal">info</i></a>
                    <a title="Order Now" href="order_display" class="pull-right "><i class="  material-icons left"
                                                                                     style="margin-bottom: 1em; color:teal">add_shopping_cart</i>
                    </a>
                </div>
            ...
            <div class="col s12 m4 card">
                ...
                <div class="card-content">
                    <span class="card-title"
                          style="color:black;font-weight:bold;font-size:1.5em">Trays & Platters</span>
                    <p style="text-align:justify;color:black!important;">We offer a variety of trays at unbelievable
                        prices. Tray sizes range from small to extra large..</p>
                </div>
                <div class="card-action">
                    <a id="trays_popup" title="More Information" data-toggle="modal"
                       style="margin-top:1em;margin-bottom:1em;" data-target="#trays_popup_dialog"
                       style="margin-bottom: 1em;cursor:hand"><i style="margin-bottom: 1em;color:teal"
                                                                 class=" material-icons left">info</i></a>
                    <a title="Order Now" href="order_display" class="pull-right "><i class="  material-icons left"
                                                                                     style="margin-bottom: 1em; color:teal">add_shopping_cart</i>
                    </a>
        ...
        <div class="row" style="margin-top:1em;">
            ...
            <div class="center">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3309.719747024528!2d25.562721314723113!3d-33.94833553062155!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1e7ad17c338823d5%3A0xc3470fd4e6b82bb0!2s69+4th+Ave%2C+Newton+Park%2C+Port+Elizabeth%2C+6055!5e0!3m2!1sen!2sza!4v1495859382197"
                        frameborder="0" style="border:0;height:300px;max-width: 100%;" allowfullscreen></iframe>
            </div>
        </div>
</div>
...
<div id="trays_popup_dialog" class="modal" role="dialog">
    ...
    <div class="modal-body">
        <div class="row">
            <p style="color:black!important;">We offer a variety of trays at unbelievable prices. Tray sizes range from
                small to extra large. Large trays serve 8-12 people and small trays serve 4-6.</p>
        </div>
        <div class="row">
            <div class="col-md-4">
...
<div id="salads_popup_dialog" class="modal" role="dialog">
    ...
    <div class="modal-body">
        <div class="row">
            <p style="color:black!important;">Party size salads are available on request. All dressings are served on
                the side.</p>
        </div>
        <div class="row">
            <div class="col-md-4">
...
<div id="sandwich_popup_dialog" class="modal" role="dialog">
    ...
    <div class="modal-body">
        <div class="row">
            <p style="color:black!important;">Choose one of our delicious fillings or design your own sandwich. Sizes
                vary from medium (15cm) to large(22cm). When designing your own sandwich you can choose the type of
                bread and any 3 additional toppings.
            </p>
        </div>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="row">
                    <div class="col s4 offset-s3">
                        <button class="btn waves-effect waves-light" type="button" id="address_action">Next<i
...
<div class="fixed-action-btn">
    ...
    <ul>
        <a class="btn-floating" href="contact_display" title="Contact Us"><i class="material-icons left">email</i>
            Contact Us</a>
        <a class="btn-floating" style="margin-top:1em;margin-bottom:1em;" href="order_display" title="Order Now"><i
                    class="material-icons left">add_shopping_cart</i> Order Now</a>
        <a class="btn-floating" href="{{ url('/login') }}" style="margin-left:1em;" title="Sign In"><i
                    class="material-icons left">verified_user</i>Sign In</a>
        ...
        <div class="row">
            <div style="margin-top:1.5em;" class="col-md-6">
                <ul>
                    ...
                    <li><a style="color:white;">Port Elizabeth - <i class="material-icons prefix">contact_phone</i> 041
                            365 7146 or WhatsApp 071 704 9449</a></li>
                </ul>
            </div>
            <div class="col-md-offset-1 col-md-4">
                ...
                <ul class="icons">
                    <li>
                        <a class="icon rounded fa-facebook"
                           href="https://www.facebook.com/The-Sandwich-Shop-174784602609962/"><span class="label">Facebook</span></a>
                    </li>
                    <li>
...
<script>
    function show_login_register_modal() {
