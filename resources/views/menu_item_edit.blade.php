	...
	<div class="row" style="margin-top:8em;">
			<div class="col-md-8 col-md-offset-2">
					<div class="panel panel-default">
							<div class="panel-heading"><h4>Edit Menu Item</h4></div>
							<div class="panel-body">
									...
									<input id="item_id" value='{{$menu_item->id}}' hidden />
											<div class="form-group" >
													...
													<div class="col-md-6">
															<input id="item_number" type="text" class="form-control" name="item_number" value="{{$menu_item->item_number}}" required >
											...
											<div class="form-group">
													...
													<div class="col-md-6">
															<input id="item_name" type="text" class="form-control" name="item_name" value="{{$menu_item->name}}" required autofocus>
                      ...
                      <div class="form-group">
                        ...
                        <input id="sandwich_prize" type="number" step='0.10' class="form-control" name="sandwich_prize" value="{{$other_item->prize}}" required autofocus>
                        @endif
                        @endforeach
                       ...
                       <div class="form-group">
                        ...
                        <input id="medium_sub" type="number" step='0.10' class="form-control" name="medium_sub" value="{{$other_item->prize}}" required autofocus>
                        @endif 
                        @endforeach
                           </div>
                       </div>
                       <div class="form-group">
                        ...
                        <input id="large_sub_prize" type="number" step='0.10' class="form-control" name="large_sub_prize" value="{{$other_item->prize}}" required autofocus>
                        @endif
                        @endforeach
                           </div>
                       </div>
                     ...
                     @foreach($other_items as $other_item)
                       @if($other_item->item_size_id==4)
                        <input id="wrap_prize" type="number" step='0.10' class="form-control" name="wrap_prize" value="{{$other_item->prize}}" required autofocus>
                        @endif
                        @endforeach
                           </div>
                       </div>
                        ...
                        <h5>Current Ingredients</h5>
											 <div class="row">
											    	<div class="input-field col s4">
												    	...
												    	<div id="ingredients_div" class="input-field" hidden><select id="ingredients" name="'ingredients'" onchange="select_ingredient()" ><option value="" >**Please select an ingredient**</option></select></div>
												</div>
											     <div id='ingredients_list' class="col s7">
                                               @foreach($ingredients as $ingredient)
                                                <div id='{{$ingredient->id}}' class='col s3 well' style="margin-left:1em;"><p id='{{$ingredient->ingredient_id}}' class="ingr" style="font-weight:bolder;" ><span id='{{$ingredient->id}}' class="material-icons close" style="cursor:pointer;" onclick="remove_ingredient(this)">close</span>{{$ingredient->ingredient->name}}  </p></div>
                                               @endforeach
                                               </div>
											 </div>
